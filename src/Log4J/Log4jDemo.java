...
import org.openqa.selenium.support.ui.Select;
	...
	public class Log4jDemo {
	   static final Logger logger = LogManager.getLogger(Log4jDemo.class.getName());
	   ...
	   public static void main(String[] args) {
	      ...
	      System.setProperty("webdriver.chrome.driver", "\\Users\\rgajul\\Documents\\Me\\elearning\\Ex_Files_Selenium_EssT\\Downloads\\chromedriver_win32\\chromedriver.exe");
			...
			KnMPress.click();
			logger.info("Scrolling successfully done");
			//AutoComplete
			...
			logger.info("Auto complete action successfully done");
			...
			logger.info("Swtiching to Active Windows");
			//switch to alert
